...
import Background from "../../Assets/Desings/card25.webp";
...
export default class Card23 extends PureComponent<IPropsCard, IStateCard> {
    ...
    render(): React.ReactNode {
        return(<>
            ...
            <ImageLazyLoadCard
                ...
                style={{
                    position: 'absolute',
                    top: this.getScale(80.2),
                    left: this.getScale(60),
                    overflow: 'hidden',
                    borderRadius: this.getScale(10),
                }}
            />
            <Text
                style={{
                    ...
                    textShadowOffset: {
                        width: this.getScale(1),
                        height: this.getScale(1)
                    },
